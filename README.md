...
**Promiedos Plus 1.0.0** es una extensión de Chrome para personalizar [Promiedos](https://www.promiedos.com.ar/): dejá las competiciones que te interesan primero y ocultá las apuestas y el encabezado principal.
...
- **Oculta el encabezado principal** con el logo y el botón de menú de Promiedos.
...
**[Descargar Promiedos Plus 1.0.0 (ZIP listo para instalar)](https://github.com/tomviglini/promiedos-chrome-extension/releases/download/v1.0.0/promiedos-plus-1.0.0.zip)** · [Ver versiones publicadas](https://github.com/tomviglini/promiedos-chrome-extension/releases).

1. Descargá `promiedos-plus-1.0.0.zip` desde **Assets / Recursos** del release y elegí **Extraer aquí / Extract here**. El ZIP contiene la carpeta `promiedos-plus-1.0.0`, que agrupa todos los archivos de la extensión.
2. Abrí `chrome://extensions`.
3. Activá **Modo de desarrollador**.
4. Pulsá **Cargar descomprimida** —o **Load unpacked**— y seleccioná la carpeta `promiedos-plus-1.0.0`, que contiene `manifest.json`. Chrome no acepta un ZIP en esta opción.
...
Las pruebas cargan la extensión real en Chromium y verifican colapsado nativo, orden visual, restauración, persistencia, sincronización entre pestañas, cambios dinámicos y ocultación de apuestas. También se verificaron en Promiedos los cambios de fecha, el filtro VIVO/TODOS y la visualización con ventanas de escritorio y de 390 píxeles de ancho.
...
- `dist/promiedos-plus-1.0.0.zip`: para GitHub e instalación manual. Contiene la carpeta `promiedos-plus-1.0.0/`, por lo que **Extraer aquí** deja todos los archivos agrupados.
- `dist/promiedos-plus-1.0.0-chrome-web-store.zip`: para subir a Chrome Web Store, con `manifest.json` en la raíz del ZIP.
